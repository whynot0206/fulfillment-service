...
V2 MVP 已新增 `commerce-service` 与 Vue 前端，并在本机完成商品、购物车、下单、支付回调和库存确认链路验证。测试、修复和剩余边界见 [`docs/mvp-v2-test-evidence-2026-09-24.md`](docs/mvp-v2-test-evidence-2026-09-24.md)。
